  ...
  return (
    ...
    >
      <div className="w-[90%] h-full flex flex-col items-start z-10">
        <h1 className="text-7xl font-extrabold mb-4">Conócenos</h1>
        <div className="w-full h-[2px] bg-gradient-to-r from-white to-black mb-8"></div>

        <div className="text-4xl leading-relaxed mb-8 w-full sm:w-7/12">
          <p className="mb-4">
          ...
          <p>
            ...
            impulsamos a nuestros clientes a alcanzar sus objetivos a través de
            soluciones de vanguardia y un servicio personalizado.
          </p>
        </div>
